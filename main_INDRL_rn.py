...
class CustomMultiAgentEnv(RawMultiAgentEnv):
    ...
    def step(self, action_dict):
        ...
        reward_k2 = contribution_degree[1] * (V_k2 - V_k2_0) / (V_k2_0 + OBJ_EPSILON) * 10 * 3 if g_done == True else 0
        reward_k3 = contribution_degree[2] * (V_k3 - V_k3_0) / (V_k3_0 + OBJ_EPSILON) * 10 * 3 if g_done == True else 0
...
if __name__ == "__main__":
    ...
    save_attach_word = str(configs_dict['max_num_steps']) + '_' \
                       + configs_dict['topology_file'] + '_INDRL_rn-10' + '_' # ！！
    ...
    if configs.benchmark:
        ...
        marl_model_dir = 'dir_model_INDRL_rn-10'  # ！！ 主要更改它 # 为避免load错误模型，dir 存放一个.pth的model文件
