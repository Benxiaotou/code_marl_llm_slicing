...
class CustomMultiAgentEnv(RawMultiAgentEnv):
    ...
    def __init__(self, config):
        ...
        obs_k_one_shape = 5 * (self.DG.number_of_nodes() - re_n_set_num_nodes) \
                          + 3 * self.max_num_links + 2 * self.max_num_links  # 节点信息(计算)，链路信息，拓扑信息
...
class InitVnetworkTrain(object):
    ...
    def __init__(self, config, data_dir, v_DG, str_v_net_name, v_remove_nodes_idx):
        ...
        # *# re_n-16
        # [0, 1, 2, 3, 4, 5, 6, 8, 11, 14, 16, 17, 18, 19, 21, 22] # 16
        # [0, 1, 2, 3, 4, 5, 8, 9, 10, 11, 14, 16, 17, 18, 21, 22] # 14
        # [0, 3, 4, 5, 6, 7, 8, 11, 13, 14, 15, 16, 17, 19, 21, 22] # 16
        # [0, 1, 2, 3, 4, 5, 6, 8, 11, 12, 13, 14, 16, 17, 20, 22] # 16
        # [0, 1, 2, 3, 4, 5, 7, 8, 11, 14, 16, 17, 18, 19, 20, 22] # 16
        # [0, 1, 2, 4, 6, 7, 8, 10, 11, 14, 15, 16, 17, 18, 19, 22] # 16
        # [0, 1, 2, 3, 4, 5, 6, 8, 11, 14, 15, 16, 17, 18, 19, 22] # 16
        # [0, 1, 2, 3, 4, 5, 8, 10, 11, 14, 16, 17, 18, 19, 20, 22] # 16
        # [0, 1, 2, 3, 4, 5, 6, 8, 11, 13, 14, 15, 16, 17, 19, 22] # 18
        ...
        # *# re_n-14
        # [0, 1, 2, 3, 4, 7, 8, 11, 14, 16, 17, 18, 19, 22] # 22
        # [0, 1, 2, 3, 5, 6, 11, 12, 13, 14, 16, 17, 21, 22] # 22
        # [0, 1, 2, 4, 5, 6, 8, 11, 14, 16, 17, 18, 21, 22] # 22
        # [0, 1, 2, 3, 4, 5, 6, 11, 12, 13, 14, 16, 18, 21] # 20
        # [2, 4, 5, 6, 8, 9, 11, 14, 16, 17, 18, 19, 21, 22] # 24
...
if __name__ == "__main__":
    ...
    save_attach_word = str(configs_dict['max_num_steps']) + '_' \
                       + configs_dict['topology_file'] + '_rn-8' + '_' # ！！
    ...
    if configs.benchmark:
        ...
        marl_model_dir = 'dir_model_rn-8_921600' # ！！ 主要更改它 # 为避免load错误模型，dir 存放一个.pth的model文件
