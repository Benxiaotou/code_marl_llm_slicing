...
class GEANTTopology(object):
    ...
    def __init__(self, RemoveNode, config, data_dir='./data/'):
        self.topology_file = data_dir + config.topology_file + '/' + config.topology_file  #
        self.shortest_paths_file = self.topology_file + '_shortest_paths'
        self.DG = nx.DiGraph()
        ...
        self.remove_nodes_idx = RemoveNode#节点索引idx
        ...
        self.re_attach_word = "_rmnd_" + "_".join(str(x) for x in self.remove_nodes_idx)
